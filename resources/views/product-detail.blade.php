        ...
        <div class="row px-xl-5">
            <div class="col-lg-5 mb-30">
                <div class="product-gallery">
                    <div class="main-image mb-3">
                        <img id="mainImage" src="{{ \Illuminate\Support\Facades\Storage::url($product->img_thumbnail) }}" alt="{{ $product->name }}" class="img-fluid">
                    </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <h3 class="font-weight-semi-bold">{{ $product->price_sale }}đ</h3>
                    <h5><del><i>{{ $product->price_regular }}đ</i></del></h5>
                    ...
                    <div>
                        <strong class="text-dark mr-3">Hướng dẫn sử dụng:</strong>
                        <p class="mb-4">{{ $product->user_manual }}</p>
                    </div>
                    <div class="d-flex mb-3">
